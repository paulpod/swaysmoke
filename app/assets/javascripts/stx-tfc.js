...
STX.TFC.prototype.dragOrdersHeader=function(e){
	...
	if(isNaN(this.initialPosition)) this.initialPosition=header.parentNode.offsetTop;
...
STX.TFC.prototype.updateValues=function(){
	...
	var price=this.centerPrice;
	var position=this.account.positions[this.stx.chart.symbol];
	if(position && this.activeTrade=="bracket_sell" || this.activeTrade=="bracket_cover")
...
STX.TFC.prototype.closeTFC=function(){
	...
	this.clearActive();
	this.hideAllDOM();
	if( !this.account.config.showOpenOrdersWhenTFCClosed && STX.hasClassName($$$(".stx-trade-panel"), "closed")) this.clearEphemeral("openOrders"); // remove open orders
...
STX.TFC.prototype.formatPrice=function(price){
	...
	if(this.tradability && (this.tradability.maxDecimalPlaces || this.tradability.maxDecimalPlaces===0)){
		...
		if(this.stx.chart.yAxis.priceFormatter){
