...
(function(){
	...
	function _translations_js(_exports) {
...
Volume Underlay,مؤشر أساس حجم التداول,Volume de sous-jacent,Volumen-Underlay,Vol Underlay,Volume Underlay,Vol subjacente,Объем под кривой,Vol. subyacente,成交量下置,取引高アンダーレイ
...
Williams Accumulation/Distribution,مؤشر التوزيع المتراكم ويليامز,Distribution/Accumulation de Williams,Williams Accumulation Distribution,Williams Accumulation Distribution,Williams Accumulation Distribution,Distribuição acumulativa de Williams,Индикатор накопления/распределения Уильямса,Distribución de acumulación Williams,威廉指标,ウィリアムズ集積/離散
...
Open In A New Tab,افتح في شريط جديد,Ouvrir dans un nouvel onglet,In einer neuen Registerkarte öffnen,Új lapon nyissa meg,Apri in una nuova scheda,Abrir num separador novo,Открыть в новой вкладке,Abrir en una nueva pestaña,在新选项卡中打开,新しいタブで開く
Showing Selling rates.,إظهار معدلات البيع,Afficher les taux de vente,Verkaufskurse werden angezeigt.,Eladási árfolyamok mutatása.,Visualizzazione tassi di vendita.,A mostrar taxas de venda.,Показываются курсы продажи.,Mostrando cotizaciones de venta.,显示销售率。,売りレートを表示。
Price information is provided for information purposes only.,ترد معلومات السعر لأغراض إعلامية فقط,Les données relatives au prix sont fournies à titre d'information uniquement.,Die Preisinformation dient ausschließlich Auskunftszwecken.,Az árinformációk megadása kizárólag tájékoztatási céllal történik.,Le informazioni sui prezzi sono fornite a solo titolo informativo.,As informações de preços são dadas apenas a título informativo.,Данные по ценам представлены только в информационных целях.,La información sobre precios se ofrece únicamente a título informativo.,价格信息仅供参考。,表示されている価格情報は参考目的に限ります。
Drawing,رسم,Dessin,Zeichnen,Rajz,Disegno,A desenhar,Рисунок,Dibujo,绘图,描画
Tools,أدوات,Outils,Tools,Eszközök,Strumenti,Ferramentas,Инструменты,Herramientas,工具,ツール
Studies A-L,دراسات أ-ل,Études A-L,Studien A-L,Felmérések A-L,Studi da A a L,Estudos A-L,Исследования A-L,Estudios A-L,研究A-L,A-Lを調査
Studies M-Z,دراسات م-ي,Études M-Z,Studien M-Z,Felmérések M-Z,Studi da M a Z,Estudos M-Z,Исследования M-Z,Estudios M-Z,研究M-Z,M-Zを調査
Momentum Oscillator,مذبذب السعر,Oscillateur de dynamique,Momentum-Oszillator,Momentum oszcillátor,Oscillatore Momentum,Oscilador de momentum,Моментум-осциллятор,Oscilador de momento,势头振荡指标,モメンタム・オシレーター
Stochastic Oscillator,Stochastic مذبذب,Oscillateur stochastique,Stochastik-Oszillator,Sztochasztikus oszcillátor,Oscillatore stocastico,Oscilador estocástico,Стохастический осциллятор,Oscilador estocástico,随机震荡指标,ストキャスティック・オシレーター
...
Showing sell rates. Price information is provided for informational purposes only.,إظهار معدلات البيعترد معلومات السعر لأغراض إعلامية فقط,Afficher tous les taux de vente. Les données relatives au prix sont fournies à titre d'information uniquement.,Verkaufskurse werden angezeigt. Die Preisinformation dient ausschließlich Auskunftszwecken.,Eladási árfolyamok mutatása. Az árinformációk megadása kizárólag tájékoztatási céllal történik.,Visualizzazione tassi di vendita. Le informazioni sui prezzi sono fornite a solo titolo informativo.,A mostrar taxas de venda. As informações de preços são dadas apenas a título informativo.,Показываются курсы продажи. Данные по ценам представлены только в информационных целях.,Mostrando cotizaciones de venta. La información sobre precios se ofrece únicamente a título informativo.,显示销售率。价格信息仅供参考。,売りレートを表示。表示されている価格情報は参考目的に限ります。
Symbol,الرمز,Symbole,Symbol,Szimbólum,Simbolo,Símbolo,Символ,Símbolo,用户名,シンボル
Username,اسم المستخدم,Nom d'utilisateur,Benutzername,Felhasználónév,Nome Utente,Nome de utilizador,Имя пользователя,Nombre de usuario,过去2年,ユーザー名
Last 2 Years,السنتان الماضيتان,2 dernières années,Letzten 2 Jahre,Az elmúlt 2 év,Ultimi 2 Anni,Últimos 2 anos,Последние два года,Últimos dos años,去年,過去 2 年間
Last Year,العام الأخير,L'année dernière,Letztes Jahr,Az elmúlt év,Ultimo Anno,Último ano,Последний год,El año pasado,1年前,昨年
1 Year Ago,منذ عام مضى,Il y a 1 an,Vor einem Jahr,Egy éve,1 Anno fa,1 ano atrás,Год назад,Hace un año,本年度,1 年前
Current Year,العام الحالي,Cette année,Aktuelles Jahr,Folyó év,Questo Anno,Ano atual,Текущий год,Durante este año,6个月前,当年
6 Months Ago,الـ 6 اشهر الماضية,Il y a 6 mois,Vor 6 Monaten,6 hónapja,6 Mesi fa,6 meses atrás,6 Месяцев назад,Hace 6 meses,3个月前,6 カ月前
3 Months Ago,الـ 3 أشهر الماضية,Il y a 3 mois,Vor 3 Monaten,3 hónapja,3 Mesi fa,3 meses atrás,3 Месяца назад,Hace 3 meses,本季度,3 カ月前
Current Quarter,الربع الحالي,Trimestre en cours,Aktuelles Quartal,Folyó negyedév,Questo Trimestre,Trimestre atual,Текущий квартал,En el presente trimestre,2个月前,当四半期
2 Months Ago,الشهران الماضيان,Il y a 2 mois,Vor 2 Monaten,2 hónapja,2 Mesi fa,2 meses atrás,2 Месяца назад,Hace 2 meses,1个月前,2 カ月前
1 Month Ago,الشهر الماضي,Il y a 1 mois,Vor einem Monat,1 hónapja,1 Mese fa,1 mês atrás,Месяц назад,Hace 1 mes,本月,1 カ月前
Current Month,الشهر الحالي,Mois en cours,Aktueller Monat,Folyó hó,Questo Mese,Mês atual,Текущий месяц,En este mes,本月,当月
*/});
...

	{
		if ( typeof define === "function" && define.amd ) {
			define( ["stx"], function(_stx) { return _translations_js(_stx); } );
		}else{	
			var _stx={
				"STX":window.STX
			};
			var _=_translations_js(_stx);
		}
	}
